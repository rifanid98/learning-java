package java14_reflection.lesson15_proxy;
 ...
 * - Terlihat aneh, tapi fitur ini sangat berguna pada kasus-kasus tertentu, bahkan saat ini populer yang namanya Spring
 *   Data yang bisa digunakan untuk memanipulasi  database cukup bermodalkan Interface, tanpa harus membuat implementasi class dan melakukan query database secara manual
 * - https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/lang/reflect/Proxy.html
 *
 * Invocation Handler
 *
 * - Saat kita membuat  proxy, kita bisa secara dinamis menerima method yang dipanggil, dan mengembalikan value di method
 *   tersebut dengan InvocationHandler
